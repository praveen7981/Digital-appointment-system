...
public class DBHelperupdateapp extends SQLiteOpenHelper {
    public DBHelperupdateapp(Context context) {
        super(context, "patientinfo.db", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase patient) {
        patient.execSQL("create table patients(id TEXT primary key,name TEXT,problem TEXT,date TEXT,app TEXT DEFAULT 0,time Text)");
